...
//Primary Controller 
String PS3MoveNavigatonPrimaryMAC = "00:06:F5:D5:8D:AD"; //If using multiple controlers, designate a primary
...
SPP SerialBT(&Btd,"Astromech:Chopper","9327"); // Create a BT Serial device(defaults: "Arduino" and the pin to "0000" if not set)
